...
public class HighestControllerTest {
  @Mock private HighestFetcher mockFetcher;
  @Mock private ResponseHandler mockResponseHandler;

  @InjectMocks private HighestController controller;
