...
public class HeaviestControllerTest {
  @Mock private HeaviestFetcher mockFetcher;
  @Mock private ResponseHandler mockResponseHandler;

  @InjectMocks private HeaviestController controller;
